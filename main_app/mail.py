...
def send_email(name, dest, link):
    ...
    server.login("nithishamukera@gmail.com", "nnfuxpufbecvyjwo")
    ...
    msg["From"] = formataddr(("TEAM RESCUE", "nithishamukera@gmail.com"))

    # One last time add your email
    server.sendmail("nithishamukera@gmail.com", dest, msg.as_string())
    server.quit()
